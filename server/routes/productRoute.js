...
router.route("/admin/product/create").post(verifyUser,roleBasedAccess('admin',"emp"),createProduct);
router.route("/admin/products").get(verifyUser,roleBasedAccess('admin',"emp"),getAdminProducts);
router.route("/admin/product/:id").put(verifyUser,roleBasedAccess('admin',"emp"),updateProductController);
